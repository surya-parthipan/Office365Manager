...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Office Credentials</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                            ...
                            <div class="col-lg-6">
                                <form role="form" action="/getdata" method="post">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="UserName(surya@gmail.com)" name="email"  tabindex="1" required>
                                        <label>Client ID</label>
                                        <input class="form-control" placeholder="eg: 1asf2-23ew3-5t6e1-wqe9g" name ="clientID" tabindex="2" required autofocus>
                                        <label>Tenant Address</label>
                                        <input class="form-control" placeholder="eg: codeninja2.onmicrosoft.com" name="tenantAdd"  tabindex="3" required>
                                        <label>Password</label>
                                        <input class="form-control" placeholder="password" name="appKey"  tabindex="4" required>
                                    </div>
                                    <%
