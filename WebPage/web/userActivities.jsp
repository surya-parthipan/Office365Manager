            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="/userActivity" method="post">
                                        ...
                                        <select class="form-control" name="user_id">
                                            <%
                                                ...
                                                for (int i=0;i<output.length;i+=4){
                                                    ...
                                                    String opp = output[i].replaceAll("\"","");
                                                    out.print("<option value="+opp+">" + op + "</option>");
                                                }
                                            %>
                                        </select>
                                        <label>Select a Plan</label>
                                        <select class="form-control" name="licPack">
                                            <option>DEVELOPER PACK</option>
                                            <option>MICROSOFT FLOW</option>
                                        </select>
                                    </div>
                                    <div>
                                        <%
