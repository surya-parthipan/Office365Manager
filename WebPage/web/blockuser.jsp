...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">BLOCK / UNBLOCK USER</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="/blockuser" method="post">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id">
                                            <%
                                                ...
                                                String resu = s.toString();
                                                System.out.println("active:"+resu);
                                                resu = resu.substring(1,resu.length()-1);
                                                String[] output = resu.split(",");
                                                for (int i=0;i<output.length;i+=4){
                                                    String op = output[i+1].replaceAll("\"","");
                                                    String o = output[i+2].replaceAll("\"","");
                                                    if (output[i+3].replaceAll("\"","").equals("Active")) {
                                                        out.print("<option value="+o+">" + op + "</option>");
                                                    }
                                                }
                                            %>
                                        </select>
            ...
            <div class="col-lg-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="/activeuser" method="post">
                                    <div class="form-group">
                                        <label>Select User</label>
                                        <select class="form-control" name="id">
                                            <%
                                                User userObj = new User();
                                                StringBuilder ss = userObj.sendGET("http://localhost:49806/api/Users/");
                                                String result = ss.toString();
                                                System.out.println("active:"+result);
                                                result = result.substring(1,result.length()-1);
                                                String[] outp = result.split(",");
                                                for (int i=0;i<outp.length;i+=4){
                                                    String op = outp[i+1].replaceAll("\"","");
                                                    String pr = outp[i+2].replaceAll("\"","");
                                                    if (outp[i+3].replaceAll("\"","").equals("Blocked")) {
